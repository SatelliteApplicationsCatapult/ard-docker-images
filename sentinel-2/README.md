...
- Generate a single Docker image: Jupyter Notebook should be optionally installed upon deployment, based on an environment variable, e.g. `JUPYTER_NOTEBOOK` set to `YES`
