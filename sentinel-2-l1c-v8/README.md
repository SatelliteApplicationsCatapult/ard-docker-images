# ARD Workflow Container for Sentinel-2 L1C Datasets ([PSD>14.2](https://step.esa.int/main/third-party-plugins-2/sen2cor/))

## Docker Hub images
Pre-built Docker images for production use can be pulled from [our Docker Hub repo](https://hub.docker.com/r/satapps/).

## Dockerfile for development
The provided [Dockerfile](Dockerfile-devel) creates a Docker image with necessary packages for running an ARD workflow for Sentinel-2 L1C datasets, set up by means of Miniconda v4.7.10. [Jupyter Notebook](https://jupyter.org/) is included for interactive development and started once the Docker image is run.
...
rpush jobS2 '{"in_scene": "S2B_MSIL1C_20171110T230849_N0206_R101_T58LFJ_20171111T000132", "s3_bucket": "public-eo-data", "s3_dir": "test/sentinel_2/"}'
...
lrange jobS2 0 -1
```
